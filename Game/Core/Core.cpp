...
void COffsets::Initialize()
{
	...
	room_goto					= Memory::FindUTPattern("\xA1\x00\x00\x00\x00\x8B\x4C\x24\x14\x50", "x????xxxxx") - 0x3F240;
	room_goto_previous			= Memory::FindUTPattern("\xE8\x00\x00\x00\x00\x8B\x0D\x00\x00\x00\x00\x3B\xC8\x75\x1A", "x????xx????xxxx");
